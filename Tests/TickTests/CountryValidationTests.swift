...
struct CountryValidationTests {
    ...
    func validPortugueseNIF(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .nationalID(.pt)])
    ...
    func validItalianCodiceFiscale(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .nationalID(.it)])
        #expect(errors.isEmpty)
    }
    ...
    func validFrenchNIR(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .nationalID(.fr)])
        #expect(errors.isEmpty)
    }
    ...
    func validPortugueseNISS(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .socialSecurity(.pt)])
        #expect(errors.isEmpty)
    }
    ...
    func validItalianSocialSecurity(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .socialSecurity(.it)])
        #expect(errors.isEmpty)
    }
    ...
    func validFrenchSocialSecurity(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .socialSecurity(.fr)])
        #expect(errors.isEmpty)
    }
    ...
    func validPortuguesePostalCode(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .postalCode(.pt)])
        #expect(errors.isEmpty)
    }
    ...
    func validItalianPostalCode(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .postalCode(.it)])
        #expect(errors.isEmpty)
    }
    ...
    func validFrenchPostalCode(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .postalCode(.fr)])
        #expect(errors.isEmpty)
    }
    ...
    func validAndorranPostalCode(value: String) {
        let errors = Tick.validate(value, validations: [.mandatory, .postalCode(.ad)])
        #expect(errors.isEmpty)
    }
    ...
    @Test func spanishPostalCode_matchesProvince() {
        let errors = Tick.validate("28001", validations: [.mandatory, .postalCode(.es, province: "28")])
        #expect(errors.isEmpty)
    }

    @Test func spanishPostalCode_wrongProvince() {
        let errors = Tick.validate("28001", validations: [.mandatory, .postalCode(.es, province: "08")])
        #expect(!errors.isEmpty)
    }
}
